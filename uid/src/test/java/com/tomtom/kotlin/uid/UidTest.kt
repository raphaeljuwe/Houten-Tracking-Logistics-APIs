...
internal class UidTest {
    ...
    @Test
    fun testEquals() {
        val id1 = Uid.fromString<Any>("00000000-0000-0000-0000-000000000001")
        val id2 = Uid.fromString<Any>("00000000-0000-0000-0000-000000000001")
        val id3 = Uid.fromString<Any>("00000000-0000-0000-0000-000000000002")
    ...
    @Test
    fun testFromStringValidUuid() {
        val uid1 = Uid.fromString<Any>("00000000-0000-0000-0000-000000000001")
        val uid2 = Uid.fromString<Any>("00000000-0000-0000-0000-000000000002")
        assertNotNull(uid1)
        assertNotNull(uid2)
        assertEquals("00000000-0000-0000-0000-000000000001", uid1.toString())
        assertEquals("00000000-0000-0000-0000-000000000002", uid2.toString())
    }
